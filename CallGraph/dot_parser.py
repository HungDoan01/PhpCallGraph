...
import sys
import glob
import CallGraph.pydot as pydot
import re
import codecs
...
def push_top_graph_stmt(str, loc, toks):
    ...
    for element in toks:
        ...
        if element == 'strict':
            ...
            raise "Unknown element statement: %r " % element
    ...
    for elm_idx, element in enumerate(toks):
        ...
        if isinstance(element, (pydot.Subgraph, pydot.Cluster)):
            ...
            if element.default_type == 'graph':
                ...
                raise "Unknown DefaultStatement: %s " % element.default_type
...
def push_default_stmt(str, loc, toks):
    ...
    if default_type in ['graph', 'node', 'edge']:
        ...
        raise"Unknown default statement: %r " % toks
